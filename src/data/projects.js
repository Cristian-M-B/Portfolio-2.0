...
const projects = [
    {
        ...
        description: 'E-commerce de electrodomésticos y tecnología. La app consta con tres niveles de ingreso (invitado, usuario y administrador), cada uno con funcionalidades adicionales. Por ejemplo el usuario puede seleccionar productos como favoritos, ver y modificar su perfil y dejar una calificación del producto que compro. Mientras que el administrador además puede gestionar los productos, las ordenes de compras y los usuarios registrados. La app incluye pasarela de pago mediante Mercado Pago.',
